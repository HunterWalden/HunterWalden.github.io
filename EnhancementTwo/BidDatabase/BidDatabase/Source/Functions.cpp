...
string getUsername()
{
	...
	while (username.length() > MAX_USERNAME_CHARACTERS)
	{
...
{
	/* TODO: Use this space to check the database once implemented
	 * Query the database for the username and password hash, if exists return true
	 * For now just use hardcoded hash "admin" to test login system
	 */
